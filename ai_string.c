 ...
 * Return: show the output destination
 */
 ...
 * @dest: character ptr the dest of the copied str
 * @src:  character ptr the source of str
...
/**
 * _chrstring - gets the length of a prefix substring.
 * @s: start string
 * @c: character
 * Return: pointer of input bytes.
 */
